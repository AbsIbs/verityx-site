            ...
            <div className="flex flex-row gap-16 items-center">
              <div className="flex flex-col flex-1 gap-12">
                ...
                <p className="text-on-bg text-2xl leading-[150%]">
                  We&apos;re obsessed with unlocking your digital potential, and
                  we refuse to settle for mediocrity. We&apos;re a passionate
                  team of experts, collaborating to craft winning digital
                  strategies that go above and beyond. Our mission is to{" "}
                  <span className="text-primary">
                    empower you to thrive online,{" "}
                  </span>
                  and we achieve this by continuously refining our craft,
                  staying ahead of industry trends, and delivering results that
          ...
          <div className="flex flex-row gap-32 px-4">
            ...
            <div className="flex flex-col flex-1 gap-6">
              ...
              <p className="text-on-bg text-lg leading-normal">
                If you have any other questions, feel free to shoot us a
                message!
              </p>
            ...
            <div className="flex flex-row gap-24 bg-on-bg py-24 px-12 rounded">
              <div className="flex flex-col gap-8 flex-1">
                <div className="flex flex-col gap-2">
                  <p className="text-on-bg-light tracking-widest">
                    CAN&apos;T WAIT?
                  </p>
                ...
                <p className="text-on-bg-light leading-normal">
                  ...
                  ultrices ac. Imperdiet iaculis tincidunt imperdiet egestas
                  elit leo vivamus et. Morbi nam sed proin nibh orci sed laoreet
